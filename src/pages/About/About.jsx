...
function About() {
  return (
    <div className="mt-20 md:mt-0 h-auto md:h-[100vh] w-full flex items-center justify-center">
      <div>
        <div className="text-center">
          <h1 className="text-center text-wrap text-3xl md:text-5xl lg:text-7xl  font-extrabold">About The Project</h1>
          <p className="mt-4 tex-wrap px-10 md:px-0 text-center">
        ...
        <div className="px-0 md:px-40 mt-10 md:mt-16 grid grid-cols-1 md:grid-cols-12 w-full">
            ...
            <div className="col-span-0 md:col-span-3 pl-0 md:pl-5 py-5 text-md w-full" >
                <div className="px-10 md:px-0 grid grid-cols-3 w-full text-sm text-wrap overflow-hidden">
                        <h1 className="font-extrabold col-span-1 text-yellow-800">Project Title:</h1>
                        <h1 className="col-span-2 text-justify ">Effective Learing on Solar Energy Technologies Through Mobile-Research-Labratory for Secondary Schools in Urban and Rural Areas</h1>
                </div>
                <div className="mt-10 px-10 md:px-0 grid grid-cols-3 w-full">
                ...
                <div className="mt-10 px-10 md:px-0 grid grid-cols-3 w-full mb-10 md:mb-0">
