    ...
    <div className="h-[100vh] w-full flex items-center justify-center">
      <div>
        <div className="text-center">
          <h1 className="text-6xl font-extrabold">About The Project</h1>
          <p className="mt-4">
        ...
        <div className="px-40 mt-16 grid grid-cols-12 w-full">
            <div className="col-span-9 border-r-2 px-10 py-5 text-md">
            ...
            <div className="col-span-3 pl-5 py-5 text-md" >
                <div className="grid grid-cols-3 w-full">
                        <h1 className="font-extrabold col-span-1">Project Title:</h1>
                        <h1 className="col-span-2">Effective Learing on Solar Energy Technologies Through Mobile-Research-Labratory for Secondary Schools in Urban and Rural Areas</h1>
                </div>
                <div className="mt-10 grid grid-cols-3 w-full">
                        <h1 className="font-extrabold col-span-1">Project ID:</h1>
                        <h1 className="col-span-2">15341</h1>
                </div>
                <div className="mt-10 grid grid-cols-3 w-full">
                        <h1 className="font-extrabold col-span-1">University:</h1>
                        <h1 className="col-span-2">Universiti Kebangsaan Malaysia (UKM)</h1>
                </div>
                <div className="mt-10 grid grid-cols-3 w-full">
                        <h1 className="font-extrabold col-span-1">Reference Code:</h1>
